---
layout: post
title:  kubeadm快速部署kubernetes(1.30.4,HA)
categories: [containerd,Cloud]
date: 2024-06-18 10:58:30 +0800
keywords: [containerd,云计算,kubernetes]
---

>本次部署基于Ubuntu20.04，并使用最新的containerd版本：20.10.24，kubernetes适用1.26.x版本，本文采用1.26.4。
...
VERSION_C=1.7.12-0ubuntu2~20.04.1

apt install containerd=$VERSION_C

VERSION_CTL="v1.30.0"

wget https://github.com/kubernetes-sigs/cri-tools/releases/download/$VERSION_CTL/crictl-$VERSION_CTL-linux-amd64.tar.gz

tar zxvf crictl-$VERSION_CTL-linux-amd64.tar.gz -C /usr/local/bin

rm -f crictl-$VERSION_CTL-linux-amd64.tar.gz
```
...
[host."https://dockerproxy.com",host."https://docker.m.daocloud.io",host."https://registry.docker-cn.com",host."https://docker.nju.edu.cn"]
